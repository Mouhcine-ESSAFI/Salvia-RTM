...
def gather_system_info():
    """
    Gathers system information including CPU, memory, disk usage, and network statistics.
    Also includes the hostname and uptime.
    """
...
def send_status_update():
    """
    Continuously sends the system status to the central server.
